...
class UserfilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create userfile" do
    assert_difference('Userfile.count') do
      post userfiles_url, params: { userfile: { date_created: @userfile.date_created, filename: @userfile.filename, owner: @userfile.owner, size: @userfile.size } }
    end
  ...
  test "should update userfile" do
    patch userfile_url(@userfile), params: { userfile: { date_created: @userfile.date_created, filename: @userfile.filename, owner: @userfile.owner, size: @userfile.size } }
